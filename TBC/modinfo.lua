...
meta =
{
    ...
    name = "Truncated Boss Cooldowns",

    -- Title of your mod that will be displayed to players
    title = "Truncated Boss Cooldowns",

    -- Description of your mod that will be displayed to players
    description = "Drastically reduces the timer on Boss Swoks and The AI, enabling quick farming without relogs. Also reduces the timer on the wormhole guardian.",
