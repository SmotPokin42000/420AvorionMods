...
meta =
{
    ...
    name = "Variable Equipment Docks",

    -- Title of your mod that will be displayed to players
    title = "Variable Equipment Docks",

    -- Description of your mod that will be displayed to players
    description = "Increases and randomizes the amount of all types of equipment at equipment docks. Also affects turret and equipment merchants. Based on and inspired by TheDeadlyShoe's 'More Turrets at Equipment Docks'.",

    -- Insert all authors into this list
    authors = {"SmotPokin42000"},
    ...
    contact = "SmotPokin42000 on Steam, SmotPokin42000#2098 on Discord",
}
